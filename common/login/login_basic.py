...
def body_a(data: str, guid=0, app_id='1000001', app_key='DJYWeb', token='', sign='', AppVer='1.0', DeviceType='android',
           Lang='zh') -> dict:
    # 获取时间戳，先转换成整形，再转换字符串
    t = int(time.time())
    timestamp = str(t)
...
if __name__ == '__main__':
    ...
    # re = djy_get_vcode('18000000006', '1000001', 'DJYWeb')
    # print(re)
    #
    # re_l = labor_pre_login('18000000006', re, 'DJYWeb')
    # print(re_l)

    re_2 = labor_weblogin('18000000006',  'DJYWeb')
    print(re_2)